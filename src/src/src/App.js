        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              From heartfelt to luxurious - find the perfect card for any occasion
            </p>
          </div>
          ...
          {sent ? (
            <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
              ...
              <p className="text-lg text-gray-600">
                Your beautiful card is on its way to {recipientEmail}
              </p>
            </div>
          ) : (
...
const CardTile = ({ card, onSelect }) => {
  return (
    <div
      ...
      className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer transform hover:scale-105 transition-all duration-200 hover:shadow-2xl"
    >
